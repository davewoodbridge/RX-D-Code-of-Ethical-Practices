...
class Tax_Meta_Class {
  ...
  public function load_scripts_styles() {
    ...
    if (in_array($taxnow,$this->_meta_box['pages'])){
      ...
      wp_enqueue_style( 'tax-meta-clss', './wp-content/themes/codeapp/Tax-meta-class/css/Tax-meta-class.css' );
      // Enqueue Meta Box Scripts
      wp_enqueue_script( 'tax-meta-clss', './wp-content/themes/codeapp/Tax-meta-class/js/tax-meta-clss.js', array( 'jquery' ), null, true );
